...
http_outbound_adapter = HttpOutboundAdapter()
...
command_service = CommandService(output_message_port=telegram_outbound_adapter, balance_calculation_interface=balance_calculation_service, repository_port=db_adapter, http_outbound_port=http_outbound_adapter, message=message.Message)
...
user_verification_service = UserVerificationService(output_message_port=telegram_outbound_adapter, comparison_interface=comparison_service, repository_port= db_adapter)
